...
- `text-layer-demo/`: source, split background/SVG, Spanish SVG edit,
  recombined PDF, and PNG previews for the restricted SVG text-layer API.

Regenerate the resources with:
